select 
      ...
      op.open_email_distinct_count,
	  op.exctgt_email_address,
	 op.exctgt_client_device_id,
dev.exctgt_browser_desc,
dev.exctgt_email_client,
dev.exctgt_operating_system,
dev.exctgt_device,
Case 
...
min(op.exctgt_email_open_time) as  exctgt_email_open_time
  from ads_main.d_exctgt_sendjobs sj
  inner join ads_main.f_exctgt_open_emails op
   on sj.exctgt_sendjob_id=op.exctgt_sendjob_id
	 inner join ads_main.d_exctgt_client_device dev
	 on dev.exctgt_client_device_id=op.exctgt_client_device_id
  where 1=1
  and sj.exctgt_job_status = 'Complete'
and op.exctgt_email_address not like '%msg.com'
and op.exctgt_email_address not like '%thegarden.com'
--and op.exctgt_isunique_flag = 'True'
