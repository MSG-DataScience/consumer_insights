...
dfa= pd.DataFrame(index=['season','week'], columns=['repeat_2016_>75miles','repeat_2016_<75miles','repeat_2015_>75miles','repeat_2015_<75miles','repeat_2015_2016','other_>75miles','other_<75miles','total'])
...
dfa.set_value('season','repeat_2015_2016',len(year20152016.index))
...
dfa.set_value('week','repeat_2015_2016',len(week20152016.index))
...
dfb= pd.DataFrame(index=['season','week'], columns=['repeat_2016_>75miles','repeat_2016_<75miles','repeat_2015_>75miles','repeat_2015_<75miles','repeat_2015_2016','other_>75miles','other_<75miles','total'])
...
dfb.set_value('season','repeat_2015_2016',"{0:.3f}".format(float(len(year20152016.index))/len(data2.index)))
...
dfb.set_value('week','repeat_2015_2016',"{0:.3f}".format(float(len(week20152016.index))/len(data4.index)))
...
dfc=dfc[['repeat_2016_>75miles','repeat_2016_<75miles','repeat_2015_>75miles','repeat_2015_<75miles','repeat_2015_2016','other_>75miles','other_<75miles','total']]
