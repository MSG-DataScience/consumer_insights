...
def update_figure(selected_days,ratio,lala,email):
    test_x=pd.read_csv("/Users/mcnamarp/Documents/consumer_insights/thao/test_xe.csv")
    clf=joblib.load('/Users/mcnamarp/Documents/consumer_insights/thao/xe.pkl')
    day=pd.read_csv("/Users/mcnamarp/Documents/consumer_insights/thao/test_date.csv")
    test_x['Facebook'][test_x.yearday > selected_days] += 100000
    test_x['Twitter'][test_x.yearday > ratio] += 100000
    test_x['promo'][test_x.yearday == lala] = 1
    test_x['sent'][test_x.yearday > email] = 10000000
    test_y=clf.predict(test_x)
